...
export const fullSuiteVitestShards = [
  ...
  {
    config: "test/vitest/vitest.full-core-unit-support-slow.config.ts",
    name: "core-unit-support-slow",
    projects: ["test/vitest/vitest.unit-support-slow.config.ts"],
  },
  {
  ...
  },
  {
    ...
    projects: [
      ...
      "test/vitest/vitest.commands-onboard.config.ts",
      "test/vitest/vitest.commands.config.ts",
      "test/vitest/vitest.agents-pi.config.ts",
      "test/vitest/vitest.agents-subagents.config.ts",
