...
describe("action review artifacts", () => {
  it("builds a neutral action review artifact for non-coding workflows", () => {
    const artifact = buildActionReviewArtifact({
      ...
      sourceMaterialPacketRef: "source-material://node-1",
      sourceMaterialPacketHash: "sha256:source-material",
      sourceMaterialSelectionRef: null,
      sourceMaterialSelectionHash: null,
  ...
  it("builds a worker edit review artifact with bounded diff evidence", () => {
    ...
    const artifact = buildWorkerEditReviewArtifact({
      ...
      workerId: "agent.execution-coding.native-node-session",
      ...
      nodeExecutionContractHash: "sha256:contract",
      sourceMaterialPacketRef: "source-material://node-implementation",
      sourceMaterialPacketHash: "sha256:source-material",
      sourceMaterialSelectionRef: "source-material-selection://node-implementation",
      sourceMaterialSelectionHash: "sha256:target",
