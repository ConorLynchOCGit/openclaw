...
export const ActionReviewArtifactSchema = z
  .object({
    ...
    nodeExecutionPacketRef: nullableString(360),
    nodeExecutionPacketHash: nullableString(160),
    domainResourcePacketRef: nullableString(360),
    domainResourcePacketHash: nullableString(160),
    domainResourceSelectionPacketRef: nullableString(360),
    domainResourceSelectionPacketHash: nullableString(160),
