      ...
      decision: decision({
        newNodes: [
          ...
          },
          {
            ...
            whyThisRoleIsNeededNow: "A focused validation node should run or record the proof.",
            exactObjective: "Run or record focused validation for the implementation.",
            evidenceExpectation: "Validation command or proof refs.",
            expectedOutput: "Bounded validation result refs.",
