...
export const productSpecPlanningWorkflowContract: ExecutionWorkflowContract = {
  ...
  description:
    "Routes bounded product/spec planning requests to a shared resource/action lifecycle workflow that produces planning intent, capsules, decision records, action graph proposals, compile-readiness evidence, and closeout without executing child actions automatically.",
  ...
  intentPatterns: {
    ...
    negativeExamples: [
      ...
      "Wire, harden, refactor, or fix Product/Spec Planning source code.",
      "Run tests for code changes.",
      "Update docs or source files directly.",
      "Deploy this feature.",
    ...
    routingHints: [
      ...
      "Use Product/Spec Planning as the executor only for planning artifacts, planning capsules, action graph proposals, compile-readiness evidence, or human decision records.",
      "Not for implementation/coding/source edits/tests/docs/refactors/hardening/migrations/wiring/bug fixes. Use agent_team.coding when changing a workflow/plugin/system.",
  ...
  workQueueProjection: {
    ...
    genericFields: [
      ...
      "runtimeJobId",
      "authorityProfile",
      "currentLifecycleGate",
      "nextLegalTransitions",
      "resourceDemandStatus",
      "resourceLedgerStatus",
      "domainResourceSelectionStatus",
      "domainActionGateStatus",
      "workflowStatus",
      "validationState",
      "reviewState",
      "closeoutState",
    ...
    extensionFields: [
      ...
      "planningOutputKind",
      "planningIntentRefs",
      "planningResourceManifestRefs",
      "planningWorkflowRefs",
      "planningCapsuleRefs",
      "planningCapsuleRevisionRefs",
      "childActionProposalRefs",
      "compileReadinessRefs",
      "humanDecisionRefs",
      "validationRefs",
      "eli5Progress",
    ],
