...
export function buildProductSpecPlanningWorkflowPlugin(input: {
  ...
  return {
    ...
    resourceNeeds: definition.resourceNeeds,
    ...
    validationExpectations: [
      ...
      "resource_demand_uses_planning_domain_handles",
      "node_resource_demand_uses_planning_resource_manifests",
      "node_resource_ledger_stores_planning_refs_not_file_bodies",
      ...
      "planning_domain_action_tools_projected_from_node_lifecycle_runner",
