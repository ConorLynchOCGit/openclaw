...
export function compactSchedulerProgressForManifest(
  ...
  return compactSchedulerProgressManifest({
    ...
    boundaryReplayGraphCheckpointRefs: boundedStrings(
      metadata.boundaryReplayGraphCheckpointRefs,
      40,
    ),
    replayStartPolicy: metadata.replayStartPolicy ?? null,
    replaySafetyStatus: metadata.replaySafetyStatus ?? null,
    replayFreshnessStatus: metadata.replayFreshnessStatus ?? null,
    replayContinuationMode: metadata.replayContinuationMode ?? null,
    nextReplayBoundary: metadata.nextReplayBoundary ?? null,
