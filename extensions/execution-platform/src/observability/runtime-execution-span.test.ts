...
describe("runtime execution spans", () => {
  ...
  it("summarizes active, stale, and blocked spans from runtime events", () => {
    const staleSpan = buildRuntimeExecutionSpan({
      ...
      modelTaskPolicyRef: "model-task-policy://global-reasoning/gpt-5.5",
      reasoningMode: "xhigh",
    ...
    expect(readback).toMatchObject({
      ...
      currentModelTaskClass: "global_reasoning",
      currentModelTaskPolicyRef: "model-task-policy://global-reasoning/gpt-5.5",
      currentReasoningMode: "xhigh",
      currentParserMode: "runtime_json_object",
