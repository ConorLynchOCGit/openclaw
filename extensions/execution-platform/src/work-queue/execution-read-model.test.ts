  ...
  it("maps Product/Spec Planning Mission Ledger evidence by commitment for owner readback", async () => {
    await withRuntime(async ({ runtimeJobs, workQueue }) => {
      ...
      await runtimeJobs.attachRuntimeArtifactByContract({
        ...
        boundedSummary: "Product/spec planning Mission Ledger fixture.",
        targetCommitmentIds: ["commitment-ledger-map", "commitment-production-evidence-buckets"],
  ...
  it("flags unbounded Product/Spec Planning Mission Ledger evidence refs in readback", async () => {
    await withRuntime(async ({ runtimeJobs, workQueue }) => {
      ...
      await runtimeJobs.attachRuntimeArtifactByContract({
        ...
        boundedSummary: "Product/spec planning raw-ref Mission Ledger fixture.",
        targetCommitmentIds: ["commitment-raw-ref"],
        resourcePacketKind: "mission_contract_ledger",
        readinessStatus: "accepted",
        reasonCodes: ["mission_contract_ledger_fixture_attached_by_contract"],
      });
