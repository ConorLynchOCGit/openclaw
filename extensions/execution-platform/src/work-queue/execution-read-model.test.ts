          ...
          parallelFrontier: {
            ...
            branchResults: [
              ...
              },
              {
                ...
                nextTransition: "open_node_resource_demand",
                evidenceRefs: [],
                readinessStateRef: "readiness://impl-b",
                reasonCodes: ["resource_handoff_missing"],
                rawPromptStored: false,
                rawResponseStored: false,
                rawProviderLogStored: false,
                rawToolLogStored: false,
            ...
            joinReadyNodeIds: [],
            nodeResourceLedgerManifestRefs: ["node-resource-ledger://impl-a/manifest"],
            rawPromptStored: false,
            rawResponseStored: false,
            rawProviderLogStored: false,
            rawToolLogStored: false,
          ...
          blockingCommitments: [
            {
              ...
              acceptedEvidenceRefs: [
                ...
                `runtime-job://${runtimeJobId}/runtime-work-graph/scheduler-role/resource_scout/context`,
  ...
  await withRuntime(async ({ runtimeJobs, workQueue }) => {
    ...
    await runtimeJobs.recordEvent({
      ...
      data: {
        ...
        capabilityUtilityRationale:
          "The scoped implementation lane is ready after node-local node resource demand.",
        ...
        eli5Progress: "The resource scout is finding the files the implementer should edit.",
        schedulerPhase: "execution_in_progress",
        ...
        resourceHandoffPacketRefs: ["runtime-job://job/resource-handoff/context-1"],
        contextQualityState: "accepted",
        openContextBlockers: [],
        budgetPolicyRef: "runtime-task-budget://agent_team.coding/resource_scout/standard",
    ...
    await runtimeJobs.recordEvent({
      ...
      data: {
        executionSpan: buildRuntimeExecutionSpan({
          ...
          currentAction: "resource scout model call is running.",
    ...
    expect(model.runtimeJobs[0]?.ownerProgressReadback.activeGraphProgress).toMatchObject({
      ...
      costAwareDecision: {
        ...
        selectedModelQualificationProfileId: null,
        qualificationEvidenceRefs: [],
        utilityRationale: "The scoped implementation lane is ready after node-local node resource demand.",
      ...
      contextScout: {
        ...
        handoffPacketRefs: ["runtime-job://job/resource-handoff/context-1"],
        openBlockers: [],
      },
      evidenceProducedRefs: ["artifact://context/context-1"],
      evidenceClaimRefs: ["artifact://context/context-1"],
      ...
      eli5Progress: "The resource scout is finding the files the implementer should edit.",
      budget: {
        policyRef: "runtime-task-budget://agent_team.coding/resource_scout/standard",
        budgetClass: "standard",
        runtimeToolTimeoutMs: 900_000,
        modelCallTimeoutMs: 900_000,
        workerLoopTurnTimeoutMs: 900_000,
  ...
  await withRuntime(async ({ runtimeJobs, workQueue }) => {
    ...
    await runtimeJobs.recordEvent({
      ...
      data: {
        ...
        currentPhase: "boundary_replay_resource_scout",
        artifactRefs: [
          "runtime-job://boundary-replay-readback-job/boundary-replay/graph/resource_scout/checkpoint-1",
          "runtime-work-graph://checkpoint/boundary-replay-checkpoint-1",
        ],
        reasonCodes: ["boundary_replay_checkpoint_recorded", "boundary:resource_scout"],
        eli5Progress: "OpenClaw recorded a replay checkpoint for resource.scout.",
        rawPromptStored: false,
        rawResponseStored: false,
        rawProviderLogStored: false,
      },
    ...
    await runtimeJobs.recordEvent({
      ...
      data: {
        ...
        reasonCodes: ["resource_scout_boundary_checkpoint_recorded"],
        rawPromptStored: false,
        rawResponseStored: false,
        rawProviderLogStored: false,
      },
    ...
    await runtimeJobs.recordEvent({
      ...
      data: {
        planRef:
          "runtime-job://boundary-replay-readback-job/boundary-replay-plan/graph/resource_scout/plan-1",
        requestedStartBoundary: "resource_scout",
        status: "accepted",
        registryVersion: "execution-platform.boundary-replay-registry.v1",
        ...
        latestAcceptedCheckpointKind: "resource_scout",
        missingCheckpointKinds: [],
        latestAcceptedCheckpointRef:
          "runtime-job://boundary-replay-readback-job/boundary-replay/graph/resource_scout/checkpoint-1",
        exactContinuationMode: "continue_scheduler",
        exactContinuationAction:
          "Continue production scheduler from resource_scout through GenericOrchestrationRuntime.",
    ...
    expect(
      ...
      state: "present",
      latestCheckpointKind: "resource_scout",
      currentReplayBoundary: "resource_scout",
      checkpointRefs: [
        "runtime-job://boundary-replay-readback-job/boundary-replay/graph/resource_scout/checkpoint-1",
      ],
  ...
  await withRuntime(async ({ runtimeJobs, workQueue }) => {
      ...
      data: {
        ...
        parallelFrontier: {
          ...
          branchScopedFrontierStates: [
            {
              ...
              nodeId: "implementation-a",
              nodeKind: "implementation",
              workIntentRef: "work-intent://planning-workflow/implementation-a",
              contractRef: "node-contract://implementation-a",
              readinessRef: "node-readiness://implementation-a",
              resourceRequirementRefs: ["resource-requirement://implementation-a"],
              domainResourcePacketRef: "runtime-work-graph://implementation-context-packet/a",
              resourcePacketRef: "runtime-work-graph://implementation-context-packet/a",
              status: "needs_review",
              blocker: {
                code: "resource_packet_bounds_exceeded",
                summary: "Resource packet exceeded bounds.",
                schemaPath: "nodeExecutionPacket.targetFileSnapshots",
                policyPath: null,
                reasonCodes: ["implementation_context_resource_packet_bounds_exceeded"],
              },
              blockerSignature:
                "resource_materialization:implementation:resource_packet_bounds_exceeded",
              ...
              successfulEvidenceRefs: ["runtime-work-graph://implementation-context-packet/b"],
              failedEvidenceRefs: ["runtime-work-graph://implementation-context-packet/a"],
          ...
          nodeResourceDemandSessionRefs: [
            "runtime-job://child-sync-runtime-job/node-resource-demand/implementation-a/session",
          ],
        ...
        frontierRootCauseArtifact: {
          ...
          successfulSiblingEvidenceRefs: ["runtime-work-graph://implementation-context-packet/a"],
          firstOccurrenceRef:
          ...
          schemaErrorPaths: ["nodeExecutionPacket.targetFileSnapshots"],
          policyErrorPaths: [],
          ...
          domainResourcePacketRefs: [],
          providerProfileIds: [],
          attemptedTransitions: ["compile_node_execution_packet"],
    ...
    expect(model.runtimeJobs[0]?.ownerProgressReadback.activeGraphProgress).toMatchObject({
        ...
        branchScopedFrontierStates: [
          {
            ...
            resourceRequirementRefs: ["resource-requirement://implementation-a"],
            dependentConsumers: ["validation-a"],
            blockerCode: "resource_packet_bounds_exceeded",
            blockerSchemaPath: "nodeExecutionPacket.targetFileSnapshots",
            successfulEvidenceRefs: ["runtime-work-graph://implementation-context-packet/b"],
            failedEvidenceRefs: ["runtime-work-graph://implementation-context-packet/a"],
            repairNodeRefs: ["runtime-work-graph://node/repair-implementation-a"],
            diagnosticOnlyNodeRefs: ["runtime-work-graph://node/diag-implementation-a"],
      ...
      latestRunState: {
        ...
        noProgressRepeatCount: 2,
        terminalBlockerCode: "graph_persistence_reused_only",
        rootCauseRecommendedRepairBoundary: "resource_materializer_fix",
