  ...
  it("builds resume and turn params from the currently selected OpenClaw model", () => {
    ...
    const appServer = {
      start: {
        ...
        headers: {},
        env: {
          OPENCLAW_RUNTIME_HOME: "/tmp/openclaw-runtime",
          HOME: "/tmp/openclaw-runtime",
          XDG_STATE_HOME: "/tmp/openclaw-runtime/state",
          XDG_CONFIG_HOME: "/tmp/openclaw-runtime/config",
          XDG_CACHE_HOME: "/tmp/openclaw-runtime/cache",
          TMPDIR: "/tmp/openclaw-runtime/tmp",
          CODEX_HOME: "/tmp/openclaw-runtime/providers/codex",
        },
      },
