...
// Keep OpenClaw session spawning out of the default direct surface in Codex
// mode so Codex's native collabAgentToolCall/spawnAgent surface remains the
// primary Codex subagent surface.
