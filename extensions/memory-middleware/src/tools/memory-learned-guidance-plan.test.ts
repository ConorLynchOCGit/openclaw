    ...
    learnedGuidanceAdvisoryPlanning: {
      plan: vi.fn(async () => ({
        ...
        rolloutScope: {
          ...
          source: "approved_preferred_workflow_guidance" as const,
          approvedOnly: false as const,
          approvedPreferred: true as const,
          candidateAdvisoryIncluded: true as const,
          advisoryOnly: true as const,
          inlineOnly: true as const,
          allowedCaptureClasses: ["workflow_generalized_guidance"] as const,
