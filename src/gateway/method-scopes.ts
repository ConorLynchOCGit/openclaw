...
const METHOD_SCOPE_GROUPS: Record<OperatorScope, readonly string[]> = {
  ...
  [READ_SCOPE]: [
    ...
    "modelMemory.proactivity.uxRemediation",
    "tools.catalog",
    "tools.effective",
    "agents.list",
    "agent.identity.get",
    ...
    "work_queue.subscribe",
    "work_queue.unsubscribe",
    "work_queue.events.replay",
    "sessions.usage",
  ...
  [WRITE_SCOPE]: [
    ...
    "modelMemory.proactivity.recordChatActivity",
    "modelMemory.proactivity.updateOpportunityState",
    "modelMemory.proactivity.recordLiveEvent",
