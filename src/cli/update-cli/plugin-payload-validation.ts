...
/**
 * Verify tracked plugin records without executing plugin code. Code packages
 * must contain parseable package metadata and declared entries; bundle
 * packages must satisfy their native bundle-manifest contract.
 */
