...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.entries.*.executionWorkspace": "Agent Execution Workspace",
  "agents.entries.*.executionWorkspace.type": "Agent Execution Workspace Type",
  "agents.entries.*.executionWorkspace.access": "Agent Execution Workspace Access",
