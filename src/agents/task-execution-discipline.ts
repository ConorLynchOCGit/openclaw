...
export function buildTaskExecutionDisciplineSection(): string[] {
  return [
    ...
    "Before declaring a task blocked, try the strongest available relevant tool surface first; do not stop at an ambient shell limitation if a better tool path still exists.",
    "For live or runtime verification, distinguish fresh evidence gathered now, prior recorded evidence, and blocked checks.",
    "If the user asked for proof or live verification, do not imply success unless the required fresh evidence was actually gathered.",
