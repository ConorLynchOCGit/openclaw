...
export type AgentCommandOpts = {
  ...
  /** Optional native provider-context admission gate for this run. */
  ...
  /** Internal control: source worktrees must not receive generated bootstrap files. */
  seedBootstrapFiles?: boolean;
