...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "list",
    label: "list",
    description: "List bounded workspace directory entries",
    sectionId: "fs",
    profiles: ["coding"],
  },
  {
    id: "glob",
    label: "glob",
    description: "List workspace files matching a bounded glob",
    sectionId: "fs",
    profiles: ["coding"],
  },
  {
  ...
  },
  {
    id: "task",
    label: "task",
    description: "Delegate bounded work to an allowed child agent through native sessions",
    sectionId: "sessions",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    id: "node_finish",
    label: "node_finish",
    description: "Finish an Execution Platform graph node with typed evidence or blocker",
    sectionId: "nodes",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    id: "read_todo",
    label: "read_todo",
    description: "Read the current session-owned structured todo state",
    sectionId: "agents",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
