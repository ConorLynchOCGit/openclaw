...
export const DEFAULT_ROOTS_FILENAME = "ROOTS.md";
export const DEFAULT_MODES_FILENAME = "MODES.md";
...
export type WorkspaceBootstrapFileName =
  ...
  | typeof DEFAULT_ROOTS_FILENAME
  | typeof DEFAULT_MODES_FILENAME;
...
const VALID_BOOTSTRAP_NAMES: ReadonlySet<string> = new Set([
  ...
  DEFAULT_ROOTS_FILENAME,
  DEFAULT_MODES_FILENAME,
]);
