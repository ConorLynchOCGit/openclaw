...
| Canonical project visibility   | Ask Main: `List the eight canonical project workspaces currently tracked in this repo and give one sentence on each.`                 | Returns the current canonized project set accurately                        | transcript                 | misses imported projects or invents archive-only projects    | `pre_push` |
