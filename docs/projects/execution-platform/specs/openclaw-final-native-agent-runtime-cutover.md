...
- **In progress:** RuntimeGeneration live proof remains active until proof/live launch demonstrates GPT 5.5 xhigh plus OpenRouter worker/scout execution through the resident generation and accepted-job path. Boundary tests and typecheck are green for the cutover; live rebuild/reload and proof acceptance are still pending.
