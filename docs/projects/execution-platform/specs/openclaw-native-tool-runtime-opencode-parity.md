...
|  15 | Context Scout Output                        | complete | The context-scout skill requires the minimum edit-start packet: direct answer, `edit_start_recommendation`, `high_signal_refs`, bounded `inline_context_windows`, compact evidence-backed `file_graph`, likely edit points, adjacent context, misses, exact follow-up asks, and risks/unknowns. The native `task` tool description now reinforces the same packet and forbids full files/broad dumps in favor of the minimum edit-start package. Verified with targeted `rg` checks and `pnpm test:file src/agents/tools/native-task-tool.test.ts -- -t "tells the parent"` on 2026-06-08.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|  16 | Scout Skill Tightening                      | complete | `skills/execution-context-scout/SKILL.md` directs scouts to ignore full-file/full-document asks, return bounded sections, use `quick`/`medium`/`very thorough`, emit `edit_start_recommendation`, and avoid raw full files; verified with targeted `rg` checks on 2026-06-08.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|  17 | Kimi Skill Tightening                       | complete | `skills/execution-node-workflow/SKILL.md` directs Kimi to ask for minimum viable edit context, update todo after scout results, and choose `enough_for_minimal_edit`, `need_exact_window`, `need_map_pass`, or `blocked_by_missing_source`; verified with targeted `rg` checks on 2026-06-08.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|  18 | Task Result Footer                          | complete | Context and validation task results now include the exact parent-visible decision footer wording from this spec; verified with `pnpm test:file src/agents/tools/native-task-tool.test.ts -- -t "runs foreground and returns child result text"` and `pnpm test:file src/agents/tools/native-task-tool.test.ts -- -t "appends the validation parent-decision footer"` on 2026-06-08.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|  19 | No Hard Decision Choke Yet                  | complete | Audit found parent decision checkpoint wording only in `src/agents/tools/native-task-tool.ts` parent-visible result formatting and tests, with no runtime next-tool enforcement gate; verified with targeted `rg` searches for decision/post-task/update_plan enforcement on 2026-06-08.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
|  27 | Focused Success Gates                       | complete | All gates in this spec are verified with focused current-state evidence: all provider-visible tools pass through the shared native result/event/truncation/readback path; read/list/grep/glob return OpenCode-grade metadata and continuation hints; oversized output becomes managed output; truncated reads are demoted from edit-ready context windows; stateRoot is excluded through native Location; context scout task results deliver bounded windows/file graph or exact follow-up asks; validation scout results persist compact validation state; editor mutations emit compact change sets; `openclaw_resource_read` rejects raw paths and `file://`; task results include parent-visible decision footers; and parent readback receives child result plus ledger refs before next action. Verified on 2026-06-09 with `pnpm test:file src/agents/pi-tool-definition-adapter.after-tool-call.fires-once.test.ts`, `pnpm test:file src/agents/tools/repo-discovery-tools.test.ts`, `pnpm test:file src/agents/pi-tools.create-openclaw-coding-tools.adds-claude-style-aliases-schemas-without-dropping-g.test.ts`, `pnpm test:file src/config/sessions/working-context.test.ts`, `pnpm test:file src/config/sessions/managed-output.test.ts`, `pnpm test:file src/agents/bash-tools.exec-foreground-failures.test.ts -- -t "managed-output | oversized                                                                                                                                    | timeout"`, `pnpm test:file src/agents/bash-tools.process.poll-timeout.test.ts -- -t "managed-output                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | poll exposes                                                                                                                                                                                                                           | timeout"`, `pnpm test:file src/agents/tools/native-task-tool.test.ts -- -t "runs foreground and returns child result text                                                                                                                                                                                                                                                                                                                          | appends the validation parent-decision footer                                                                                                                                                             | projects structured oversized child output            | projects unstructured oversized child output                                                                                           | requires a native child-session runtime                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | uses the native child-session runner | provider response timeouts"`, `pnpm test:file src/agents/pi-embedded-runner/run-child-session-runtime.test.ts -- -t "native child sessions | provider response timeouts                   | bounded partial child output | oversized child task output"`, `pnpm test:file src/agents/pi-embedded-runner/run/llm-idle-timeout.test.ts -- -t "request-idle | resets timer | throws on idle timeout"`, `pnpm test:file src/agents/pi-tools.read.host-edit-recovery.test.ts`, `pnpm test:file src/agents/pi-embedded-runner/run/attempt.test.ts -- -t "stale edit re-grounding | decision footers"`, and `pnpm test:file extensions/execution-platform/src/workflows/node-agent-session.test.ts -- -t "blocks authored worker prompts | rejects local source file paths | does not hydrate runtime artifacts outside | native OpenClaw session trace | managed output | child-result delivery status | oversized child results"`. `git diff --check -- src/agents/pi-embedded-runner/run/attempt.test.ts docs/projects/execution-platform/specs/openclaw-native-tool-runtime-opencode-parity.md` also passed. |
...
- route managed-output inspection through the correct scout.
...
Context scout returns a minimum edit-start package, not everything relevant.

Required sections:

- direct answer;
- exact files touched;
- complete bounded source windows;
- file graph edges;
- likely edit points;
- whether enough exists for a minimal edit;
...
- prefer map plus top edit windows;
...
- ask scouts for minimum viable edit context;
...
Keep deterministic continuation wording in the parent-visible tool result.
...
- task results include parent-visible decision footer;
