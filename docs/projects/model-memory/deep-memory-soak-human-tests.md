...
| post_ingest            | project inventory retrieval        | Ask Main: `List the eight canonical project workspaces currently tracked in this repo and give one sentence on each.`                                | Returns the rescued canonical projects with reasonable descriptions                                       | session transcript, later retrieval trace                     | misses core imported projects or invents stale ones                                        | `yes`                            |
