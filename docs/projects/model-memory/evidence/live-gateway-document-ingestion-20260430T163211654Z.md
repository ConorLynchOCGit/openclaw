...
- Run ID: `live-gateway-ui-doc-20260430T163211654Z`
- Record path: `.artifacts/model-memory/phase2-live-gateway-ui-model-owned-validation/20260430T163211654Z/document-ingestion-record.json`
...
```json
{
  ...
  "runId": "live-gateway-ui-doc-20260430T163211654Z",
  "recordPath": ".artifacts/model-memory/phase2-live-gateway-ui-model-owned-validation/20260430T163211654Z/document-ingestion-record.json",
  "chunkSize": 2,
  "maxConcurrency": 1,
  "resume": false,
...
- Pass sources [".artifacts/model-memory/phase2-live-gateway-ui-model-owned-validation/20260430T163211654Z/fixtures/live-gateway-structured-doc-20260430T163211654Z.md", "memory/2026-04-30.md"].
...
- After the run, inspect .artifacts/model-memory/phase2-live-gateway-ui-model-owned-validation/20260430T163211654Z/document-ingestion-record.json and the model-memory operator evidence surfaces for captured claims and write decisions.
