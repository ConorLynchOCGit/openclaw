...
- Run ID: `pre-gateway-doc-smoke-20260430T203746Z`
- Record path: `.artifacts/model-memory/pre-gateway-doc-smoke-20260430T203746Z/document-ingestion-record.json`
...
- Ignored windows: `2`
- Rejected windows: `0`
- Write decisions: `{"write":5,"quarantine":2}`
...
```json
{
  ...
  "runId": "pre-gateway-doc-smoke-20260430T203746Z",
  "recordPath": ".artifacts/model-memory/pre-gateway-doc-smoke-20260430T203746Z/document-ingestion-record.json",
  "chunkSize": 2,
  "maxConcurrency": 1,
  "resume": false,
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- | ------: | -------: | ---------------------------- | ------- |
| `.artifacts/model-memory/phase2-live-gateway-ui-model-owned-validation/20260430T195228049Z/fixtures/live-gateway-structured-doc-20260430T195228049Z.md` | completed |       1 |        0 | `{"write":4}`                |         |
| `memory/2026-04-30.md`                                                                                                                                  | completed |       1 |        0 | `{"quarantine":2,"write":1}` |         |
...
- After the run, inspect .artifacts/model-memory/pre-gateway-doc-smoke-20260430T203746Z/document-ingestion-record.json and the model-memory operator evidence surfaces for captured claims and write decisions.
