...
Generated at: 2026-04-18T12:55:12.117Z
...
- total windows: 1
- candidate counts by type: {"reference":2,"rule":9}
- canonicalized counts by kind: {"reference":1,"rule":5}
- validation rejects: 0
- write decisions: {"write":6}
- adjudication outcomes: {"no_candidates":6}

| document                | windows | pass1 candidates           | accepted kinds             | accepted classes              | rejects | writes        | active delta               | memory projection       |
| ----------------------- | ------: | -------------------------- | -------------------------- | ----------------------------- | ------: | ------------- | -------------------------- | ----------------------- |
| `docs/system/memory.md` |       1 | `{"reference":2,"rule":9}` | `{"reference":1,"rule":5}` | `{"reference":1,"project":5}` |       0 | `{"write":6}` | `{"reference":1,"rule":5}` | `MEMORY.md (2 bullets)` |
