...
- keep storage writes deterministic and conservative
...
The runtime pipeline is identical for both supported source types after source adaptation:
...
6. identity and dedupe
7. review and write policy
8. storage

The only difference between documents and turns is the source envelope and chunking policy.
...
- fuzzy merge is out of scope for live writes in v1
