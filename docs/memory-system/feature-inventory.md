...
| -------------------------------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------- |
| Semantic learning-event detector                               | `built_offprod_or_partial` | A first bounded semantic detector is now live for the response-style family only, but broader event-family detection is still not implemented.                                                                                                         | `extensions/memory-middleware/src/ordinary-turn-auto-capture.ts`, `extensions/memory-middleware/src/tools/candidate-submit.ts`, `extensions/memory-middleware/src/response-style-semantic.ts` | Natural messy phrasing is materially better only for the first response-style family, not the broader roadmap.     | `/memory-system/specs/semantic-event-detector`                                                                                         |
| Ambiguity / clarify-abstain policy                             | `built_offprod_or_partial` | The locked ambiguity policy is now implemented for bounded response-style memory, but not yet generalized across other semantic families.                                                                                                              | response-style semantic detection, ordinary-turn capture, candidate submit, bounded rejection handling                                                                                        | Users do not yet get the same clarify/abstain behavior outside the response-style family.                          | `/memory-system/specs/ambiguity-and-clarification`                                                                                     |
| Candidate confirmation lifecycle                               | `built_offprod_or_partial` | Pending-confirmation candidate handling is now live for bounded response-style subjects, including confirmation and cleanup behavior, but not yet for other memory families.                                                                           | `extensions/memory-middleware/src/response-style-lifecycle.ts`, ordinary-turn capture, candidate submit                                                                                       | Machine-evaluated candidate lifecycles are still limited to the first response-style slice.                        | `/memory-system/specs/candidate-confirmation-lifecycle`                                                                                |
...
| Messy-language eval framework                                  | `built_offprod_or_partial` | A checked-in eval gate now exists for the bounded response-style family, but there is still no broader cross-family corpus.                                                                                                                            | `extensions/memory-middleware/src/response-style-semantic.test.ts`                                                                                                                            | We can now prove semantic capture for the response-style slice only, not for later semantic families.              | `/memory-system/specs/messy-language-eval`                                                                                             |
