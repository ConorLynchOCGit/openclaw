...
export const en: TranslationMap = {
  ...
  workboard: {
    ...
    promotionButton: "Promote candidate",
    promotionTitle: "Business Ops promotion",
    promotionSubtitle: "Candidate decision and native Workboard commitment.",
    promotionCandidateId: "Candidate ID",
    promotionSourceRef: "Source reference",
    promotionProjectRef: "Project reference",
    promotionOwnerMode: "Owner mode",
    promotionTargetWindow: "Target window",
    promotionParents: "Parent card IDs",
    promotionDecisionBoundary: "Decision boundary",
    promotionApprovalNote: "Approval note",
    promotionProposedLearning: "Proposed learning",
    promotionPreview: "Preview",
    promotionApprove: "Approve commitment",
    promotionPreviewReady: "Preview ready",
    promotionDetailTitle: "Business Ops provenance",
    promotionActor: "Approved by",
    promotionApprovedAt: "Approved",
    promotionNoTargetWindow: "No target window",
    promotionInternalOnly: "Internal work only",
    promotionLearningTitle: "Proposed Business Ops learning",
    ownerModeHuman: "Human",
    ownerModeAgent: "Agent",
    ownerModeShared: "Shared",
    noAgent: "No agent",
    promotionAction: {
      create: "Create one commitment",
      update: "Update existing commitment",
      unchanged: "No mutation needed",
    },
